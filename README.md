...
[![CI](https://img.shields.io/github/actions/workflow/status/yourusername/url-shortening-service/ci.yml?branch=main&label=CI&logo=github)](https://github.com/Lexv0lk/url-shortening-service/actions)
